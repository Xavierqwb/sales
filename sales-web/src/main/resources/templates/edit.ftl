...
<div class="g-doc">
    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/sales/editSubmit?id=${product.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt price" name="price" value="${(product.price/100)?c}"/>元
                </div>
            </div>
